...
export const componentCatalog = [
  ...
  },
  {
    ...
    title: "Input",
    category: "Components",
    primitive: "Input, InputGroup, InputGroupInput",
    files: ["src/components/ui/input.tsx", "src/components/ui/input-group.tsx"],
    figmaSource: "Compact controls",
    description: "Text entry primitives with prefix and suffix composition.",
    custom: false,
  },
  {
    id: "textarea",
    ...
    figmaSource: "Compact controls",
    description: "Multi-line text entry using the shared field surface.",
    custom: false,
  },
  {
    id: "kbd",
