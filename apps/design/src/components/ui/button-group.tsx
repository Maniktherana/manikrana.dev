...
const buttonGroupVariants = cva(
  "relative flex w-fit items-stretch overflow-visible rounded-lg shadow-[var(--shadow-card)] *:focus-visible:relative *:focus-visible:z-10 has-[>[data-slot=button-group]]:items-center has-[>[data-slot=button-group]]:gap-2 has-[>[data-slot=button-group]]:overflow-visible has-[>[data-slot=button-group]]:rounded-none has-[>[data-slot=button-group]]:bg-transparent has-[>[data-slot=button-group]]:shadow-none has-[select[aria-hidden=true]:last-child]:[&>[data-slot=select-trigger]:last-of-type]:rounded-r-lg [&>[data-slot]:not([data-slot=button-group]):not([data-slot=button-group-separator])]:border-0 [&>[data-slot]:not([data-slot=button-group]):not([data-slot=button-group-separator])]:text-foreground [&>[data-slot]:not([data-slot=button-group]):not([data-slot=button-group-separator])]:shadow-none [&>[data-slot]:not([data-slot=button-group]):not([data-slot=button-group-separator])]:bg-clip-border [&>[data-slot]:not([data-slot=button-group]):not([data-slot=button-group-separator])]:before:hidden [&>[data-slot]:not([data-slot=button-group]):not([data-slot=button-group-separator]):hover]:bg-accent [&>[data-slot]:not([data-slot=button-group]):not([data-slot=button-group-separator])[aria-expanded=true]]:bg-accent [&>[data-slot]:not([data-slot=button-group]):not([data-slot=button-group-separator])[data-popup-open]]:bg-accent [&>[data-slot=input]]:flex-1 [&>[data-slot=input]]:py-0 [&>[data-slot=input-group]]:flex-1 [&>[data-slot=select-trigger]:not([class*='w-'])]:w-fit",
  {
    variants: {
      variant: {
        default:
      ...
      orientation: {
        horizontal:
          "[&>[data-slot]:not([data-slot=button-group]):not([data-slot=button-group-separator])]:rounded-none! [&>[data-slot]:not([data-slot=button-group]):not([data-slot=button-group-separator]):first-child]:rounded-l-lg! [&>[data-slot]:not([data-slot=button-group]):not([data-slot=button-group-separator]):last-child]:rounded-r-lg! [&>[data-slot]:not([data-slot=button-group]):not([data-slot=button-group-separator])+[data-slot]:not([data-slot=button-group]):not([data-slot=button-group-separator])]:border-l! [&>[data-slot]:not([data-slot=button-group]):not([data-slot=button-group-separator])+[data-slot]:not([data-slot=button-group]):not([data-slot=button-group-separator])]:border-border",
        vertical:
          "flex-col [&>[data-slot]:not([data-slot=button-group]):not([data-slot=button-group-separator])]:rounded-none! [&>[data-slot]:not([data-slot=button-group]):not([data-slot=button-group-separator]):first-child]:rounded-t-lg! [&>[data-slot]:not([data-slot=button-group]):not([data-slot=button-group-separator]):last-child]:rounded-b-lg! [&>[data-slot]:not([data-slot=button-group]):not([data-slot=button-group-separator])+[data-slot]:not([data-slot=button-group]):not([data-slot=button-group-separator])]:border-t! [&>[data-slot]:not([data-slot=button-group]):not([data-slot=button-group-separator])+[data-slot]:not([data-slot=button-group]):not([data-slot=button-group-separator])]:border-border",
      },
    },
    defaultVariants: {
      variant: "default",
