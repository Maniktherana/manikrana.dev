  ...
  return (
    <CheckboxPrimitive.Root
      ...
      className={cn(
        ...
        "data-checked:[&_[data-slot=checkbox-box]]:bg-[var(--button-primary-hover)] data-checked:[&_[data-slot=checkbox-box]]:shadow-[0_1px_2px_0_rgb(0_0_0_/_24%),0_0_0_1px_color-mix(in_srgb,var(--button-primary-hover),var(--foreground)_28%)]",
        "data-indeterminate:[&_[data-slot=checkbox-box]]:bg-[var(--button-primary-hover)] data-indeterminate:[&_[data-slot=checkbox-box]]:shadow-[0_1px_2px_0_rgb(0_0_0_/_24%),0_0_0_1px_color-mix(in_srgb,var(--button-primary-hover),var(--foreground)_28%)]",
        className,
      )}
      {...props}
    >
      <span
        ...
        className="pointer-events-none absolute top-1/2 left-1/2 size-3.5 -translate-x-1/2 -translate-y-1/2 rounded-[3px] transition-[box-shadow]"
      />
      <span
        aria-hidden="true"
        data-slot="checkbox-box"
        className={cn(
          "absolute top-1/2 left-1/2 size-3.5 -translate-x-1/2 -translate-y-1/2 rounded-[3px] bg-[var(--control-unchecked-bg)] transition-[background-color,box-shadow]",
